...
<head>
    ...
    <title>Edit Aktifitas - MyPortfolio</title>
...
<body>
    ...
    <section class="hero-bg text-white py-4">
        <div class="container text-center">
            <h1 class="fw-bold mb-3">Edit Aktifitas</h1>
            <p class="lead">Ubah informasi aktifitas yang sudah ada</p>
        </div>
    </section>

    <!-- Edit Activity Form Section -->
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        <div class="card-header bg-warning text-dark">
                            <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Aktifitas</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="/aktifitas/{{ $aktifitas->id }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" 
                                           ...
                                           value="{{ old('nama_aktifitas', $aktifitas->nama_aktifitas) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="4" placeholder="Masukkan deskripsi aktifitas" required>{{ old('deskripsi', $aktifitas->deskripsi) }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" 
                                           ...
                                           value="{{ old('tanggal', $aktifitas->tanggal) }}" required>
                                </div>
                                
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-warning flex-fill text-dark">
                                        <i class="fas fa-save me-2"></i>Update Aktifitas
                                    </button>
                                    <a href="/aktifitas" class="btn btn-secondary">
                                        <i class="fas fa-times me-2"></i>Batal
                                    </a>
                                    <a href="/aktifitas/{{ $aktifitas->id }}" class="btn btn-info text-white">
                                ...
                                <div class="mt-4 pt-3 border-top">
                                    <small class="text-muted">
                                        ...
                                        Aktifitas ini dibuat pada: 
                                        @if($aktifitas->created_at)
                                            {{ $aktifitas->created_at->format('d M Y H:i') }}
                                        @else
                                            -
                                        @endif
                                    </small>
